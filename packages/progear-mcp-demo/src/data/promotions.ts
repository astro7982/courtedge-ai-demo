...
export const promotions: Promotion[] = [
  ...
  { code: 'FBSEASON26',   description: 'Football season equipment package',                    discountPct: 12, startDate: '2026-07-01', endDate: '2026-09-30', active: false, eligibleCategories: ['Football'] },
  { code: 'DIAMOND26',    description: 'Baseball & softball spring kickoff',                    discountPct: 15, startDate: '2026-02-01', endDate: '2026-04-30', active: true,  eligibleCategories: ['Baseball'] },
  { code: 'MULTISPORT',   description: 'Multi-sport volume bundle — 3+ categories',             discountPct: 10, startDate: '2026-01-01', endDate: '2026-12-31', active: true,  minOrderValue: 5000 },
];
